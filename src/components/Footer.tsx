    ...
    <footer className="bg-card border-t border-border mt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4 mt-6">
              ...
              <a href="mailto:info@ascremosas.com" className="text-foreground hover:text-accent transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/b2b" className="text-muted-foreground hover:text-accent transition-colors">
                  {t.nav.b2b}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/legal" className="text-muted-foreground hover:text-accent transition-colors">
                  {t.footer.legal}
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center text-muted-foreground text-sm">
          <p>&copy; {new Date().getFullYear()} AS Cremosas. {t.footer.rights}.</p>
        </div>
      </div>
    </footer>
  );
